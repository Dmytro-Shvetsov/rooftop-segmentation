...
data_root = '/Users/vozak16/projects/rooftop-segmentation/data/mnt/drones_dataset_25cmpx/airs_proto/'
data_root_annot = '/Users/vozak16/projects/rooftop-segmentation/airs_annotations_2022-12-06/'
classes = 'rooftop',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root_annot + 'train_annotations.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root_annot + 'val_annotations.json',
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root_annot + 'test_annotations.json',
